                      ...
                      <tr key={key}>
                        ...
                        <td >
                          {maps?.map((map, i) => {
                            {if (patient._id === map.patientUUID) {
                              return (
                                <p key={i}> {map.placebo? "Placebo" : "Bavaria"} </p>
                              )
                            }}
                          })}
                        </td>
                        <td>
                            ...
                            ? <Button disabled variant="contained" sx={{m:1}}>Drug Assigned</Button>
                            : <Button variant="contained" sx={{m:1, mr:3}} onClick={() => {assignDrug(patient._id)}} >Assign Drug</Button>}
                        </td>
                      </tr>
                    )})}
                    </tbody>
